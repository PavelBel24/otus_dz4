...
[root@lvm ~]# 
```
#### 1.2 Создание нового временного / 
...
Это необходимо выполнить т.к. изменилось расположение / на дисковых устройствах, и чтобы при выполнении grub2-mkconfig не изменилось устройство на котором расположен / .
